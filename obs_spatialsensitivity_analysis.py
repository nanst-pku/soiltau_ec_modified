...
regrid_cube.coord('lat').guess_bounds()
regrid_cube.coord('lon').guess_bounds()
...
obs_temp_file = iris.load_cube('observational_datasets/Tair_WFDEI_ann.nc')
...
# ncscd
ncscd_file = Dataset('observational_datasets/NCSCDV22_soilc_0.5x0.5.nc')
ncscd_data = ncscd_file.variables['soilc'][:]
n_lat_ncscd = ncscd_file.variables['lat'][:]
n_lon_ncscd = ncscd_file.variables['lon'][:]
# hwsd
hwsd_file = Dataset('observational_datasets/HWSD_soilc_0.5x0.5.nc')
...
cubes = iris.load('observational_datasets/CARDAMOM_2001_2010_FL_RHE.nc')
for cube in cubes:
...
npp_file = Dataset('observational_datasets/MOD17A3_Science_NPP_mean_00_14_regridhalfdegree.nc')
...
raich_rs_file = Dataset('observational_datasets/sr_daily_0.5degree.nc')
...
rh_file_hashimoto = Dataset('observational_datasets/RH_yr_Hashimoto2015.nc')
