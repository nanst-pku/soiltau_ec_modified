...
for temp_option in range(0, temperature_change_options_length):
    ...
    for ssp_option in range(0, ssp_options_length):
        ...
        for model_i in range(0, n_models):
            ...
            tas_preindustrial_cube = combine_netCDF_cmip6('cmip6_data/tas_Amon_'+model+'_historical*', model)
            ...
            tas_cube = combine_netCDF_cmip6('cmip6_historical_'+ssp+'/tas_Amon_'+model+'_*', model)
            ...
            rh_cube = combine_netCDF_rh_cmip6('cmip6_historical_'+ssp+'/rh_Lmon_'+model+'_*', model)
            rh_cube = open_netCDF(rh_cube)
            cSoil_cube = combine_netCDF_cSoil_cmip6('cmip6_historical_'+ssp+'/cSoil_Emon_'+model+'_*', model)
